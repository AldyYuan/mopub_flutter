...
class MoPubRewardedVideoAd {
  ...
  MoPubRewardedVideoAd(this.adUnitId, this.listener, {this.reloadOnClosed = false}) {
  ...
  Future<bool?> isReady() async {
    try {
      var result = await _channel.invokeMethod(HAS_REWARDED_VIDEO_METHOD, <String, dynamic>{
        'adUnitId': adUnitId,
      });
      return result;
    } on PlatformException {
