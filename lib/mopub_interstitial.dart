...
class MoPubInterstitialAd {
  ...
  MoPubInterstitialAd(this.adUnitId, this.listener, {this.reloadOnClosed = false}) {
  ...
  Future<bool?> isReady() async {
    try {
      var result = await _channel.invokeMethod(HAS_INTERSTITIAL_METHOD, <String, dynamic>{
        'adUnitId': adUnitId,
      });
      return result;
    } on PlatformException {
